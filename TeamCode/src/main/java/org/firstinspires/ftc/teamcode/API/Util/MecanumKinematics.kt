...
object MecanumKinematics {
    ...
    fun robotToWheelVelocities(
        ...
        return listOf(
                Range.clip(( robotVel.x - lateralMultiplier * robotVel.y + k * robotVel.heading), -1.0, 1.0), // fl
                Range.clip((-robotVel.x - lateralMultiplier * robotVel.y + k * robotVel.heading), -1.0, 1.0), // bl
                Range.clip(( robotVel.x - lateralMultiplier * robotVel.y - k * robotVel.heading), -1.0, 1.0), // br
                Range.clip((-robotVel.x - lateralMultiplier * robotVel.y - k * robotVel.heading), -1.0, 1.0)  // fr
        )
    }
